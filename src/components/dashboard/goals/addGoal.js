                                    ...
                                    <div className="col-lg-8 col-md-7">
                                        <div className="card">
                                            <div className="header">
                                                <h4 className="title">What INSPIRES me to Save?</h4>
                                            </div>
                                            <div className="content">
                                                <div className="row">
                                                    <div className="col-md-12">
                                                        <div className="form-group">
                                                            ...
                                                            <input
                                                                type="text"
                                                                className="form-control border-input"
                                                                placeholder="what touches my heart today?"
                                                                name="title"
                                                                id="title"
                                                                onChange={event => this.handleChange(event)}
                                                                required
                                                    ...
                                                    <div className="col-md-12">
                                                        <div className="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                type="number"
                                                                className="form-control border-input"
                                                                placeholder="target # of weeks to achieve my hope"
                                                                name="weeks"
                                                                min="1"
                                                                onChange={event => this.handleChange(event)}
                                                                required
                                                ...
                                                {this.state.renderWeeks.length > 0 ? <div className="header">
                                                    <h4 className="title">What can I commit for each week?</h4><br/>
                                                </div> : ''}
