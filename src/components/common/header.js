              ...
              <li>
                <a>
                  <span className="text-vertical-align-center">
                    <i
                      className="fas fa-piggy-bank fa-lg"
                      style={{ color: 'pink' }}
                    />
                    <p style={{ color: 'black' }}>
                      &nbsp; ${' '}
                      {this.props.userReducer.user
                        ? this.props.userReducer.user.saving
                        : ''}
                    </p>
                  </span>
                </a>
                ...
                <a>
                  <span className="text-vertical-align-center">
                    ...
                    <p style={{ color: 'black' }}>
                      &nbsp;
                      {this.props.userReducer.user
                        ? this.props.userReducer.user.coins
                        : ''}
                    </p>
                  </span>
                </a>
                ...
                <a>
                  <span className="text-vertical-align-center">
                      ...
                      <img
                        src={
                          this.props.userReducer.profile
                            ? this.props.userReducer.profile.imageURL
                            : ''
                        }
                        alt="profile"
                        className="img-circle img-no-padding img-responsive"
                    ...
                    <p style={{ color: 'black' }}>
                      &nbsp;&nbsp;
                      {this.props.userReducer.profile
                        ? this.props.userReducer.profile.fullName
                        : ''}
                    </p>
                  </span>
                </a>
